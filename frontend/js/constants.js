const contractAddress = "0xbe8408009cbbcdda2d4cca27fd29d106e5dac600"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to The Rich Boys Club!!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'TRBC is a collection of black avatars taking on the Metaverse in fresh ways. With each series comes a host of adventures in unique NFTs styles.';
...
const p_presale_coming_soon = "We are working hard to launch the NFT Collection. Stay tuned for TRBC updates!";
...
const button_presale_mint_not_whitelisted = "Get on the TRBC Whitelist";
const button_presale_already_minted = "Join The TRBC Community";
